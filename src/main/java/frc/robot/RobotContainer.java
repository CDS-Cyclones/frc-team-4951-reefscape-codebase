...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    m_DriverController.x().whileTrue(new AimWhileDriveCommand(m_Swerve, m_DriverController).repeatedly());
    // m_DriverController.y().whileTrue(new AimAndGetInRangeCommand(m_Swerve, m_DriverController).repeatedly());
