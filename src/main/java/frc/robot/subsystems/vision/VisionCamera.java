...
public class VisionCamera extends SubsystemBase {
  ...
  private Optional<EstimatedRobotPose> poseEst;


  /** Creates a new Camera. */
  public VisionCamera(String camName, Transform3d robotToCam) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public final double getDesiredTurn(DoubleSupplier yawSupplier, double maxRotSpeed) {
    return -1.0 * MathUtil.applyDeadband(yawSupplier.getAsDouble(), Math.PI) * maxRotSpeed;
  }
}
